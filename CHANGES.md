...
- **Estado**: `[x]` completado — 479/479 tests, 0 regresiones
- **Scope**:
...
- **Estado**: `[x]` completado — 307/307 tests, 0 regresiones
- **Scope**:
...
- **Estado**: `[x]` completado — 334/334 tests, 0 regresiones
- **Scope**:
...
- **Estado**: `[x]` completado — 2026-06-20
- **Scope**:
...
- **Estado**: `[x]` completo (2026-06-21) — Migración 018, modelos Tarea/ComentarioTarea, repos, service con FSM, router 7 endpoints. Suite: 43 passed, 0 failed (Rodrigo: 773 completa verde).
- **Scope**:
...
- **Estado**: `[x]` completo (2026-06-21) — Scaffold Vite+React+TS, cliente HTTP Axios con refresh single-flight, login+2FA+logout, bootstrap de sesión, route guards, AppShell con menú filtrado por permisos, forgot+reset password. Suite: 41 passed, 0 failed.
- **Scope**:
