...
from app.api.v1.routers import analisis, asignaciones, auth, auditoria, avisos, calificaciones, coloquios, comunicaciones, equipos, estructura_academica, health, padron, programas_y_fechas, usuarios
